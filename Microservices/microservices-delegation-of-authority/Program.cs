...
{
    options.SwaggerDoc("HRServicesAPISpec",
...
builder.Services.AddScoped<IDelegationOfAuthorityRepository, DelegationOfAuthorityRepository>();

// Service DI
builder.Services.AddScoped<IUserService, UserService>();
builder.Services.AddScoped<IEmployeeService, EmployeeService>();
builder.Services.AddScoped<IDelegationOfAuthorityService, DelegationOfAuthorityService>();
